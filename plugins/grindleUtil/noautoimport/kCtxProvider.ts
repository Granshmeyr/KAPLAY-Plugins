...
export function kCtxProvider(k: KAPLAYCtx) {
    ...
    type RotAroParams = ConstructorParameters<
        typeof RotateAroundControllerNoCtx
    >
    class RotateAroundController extends RotateAroundControllerNoCtx {
        constructor(obj: RotAroParams[1], onGetOrigin: RotAroParams[2]) {
    ...
    return {
        ...
        rootPos,
        toRoot: (obj: RooPosParams[0], offset: Vec2) =>
            rootPos(obj).add(offset),
    } as const
}
